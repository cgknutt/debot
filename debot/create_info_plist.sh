...
echo "🔍 Checking for Info.plist file..."
...
if [ -f "$INFO_PLIST_PATH" ]; then
    echo "✅ Info.plist already exists at $INFO_PLIST_PATH"
else
    echo "⚠️ Info.plist not found. Creating a minimal one..."
...
EOL
    ...
    echo "✅ Created new Info.plist at $INFO_PLIST_PATH"
fi
