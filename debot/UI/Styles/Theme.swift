...
enum Theme {
    ...
    enum Colors {
        ...
        // Brand colors - now using the centralized definitions
        static let debotOrange = Color.debotOrange
        static let debotGold = Color.debotGold
        static let debotBrown = Color.debotBrown
    }
